...
function EditProfile() {
  ...
  const validateNickname = async (value) => {
    try {
      ...
      const nicknames = Array.isArray(responseData)
        ? responseData.map((member) => member.nickname)
        : [];
        ...
        <div className={classes.MainContainer}>
          ...
          <div className={classes.NicknameContainer}>
            ...
            <div className={classes.UserNicknameContainer}>
                ...
                {...register("Nickname", {
                  ...
                  validate: {
                    isAvailable: async (value) => {
                      ...
                      return (
                        isNicknameAvailable || "이미 사용중인 닉네임입니다.4"
                      );
                    },
                  },
                })}
              ...
              {isNicknameBlurred && errors.Nickname && (
                <small className={classes.UserNicknameMSG}>
          ...
          <div className={classes.NewPasswordContainer}>
            ...
            <div className={classes.UserNewPasswordContainer}>
              <input
                ...
                {...register("NewPassword", {
                  ...
                  pattern: {
                    ...
                    message:
                      "영문 대,소문자와 숫자, 특수기호(@$!%*#?&)가 적어도 1개 이상씩 포함되어야 합니다.",
                  },
                })}
                defaultValue={""}
              ...
              />
              {errors.NewPassword && (
                <small className={classes.UserNewPasswordMSG}>
          ...
          <div className={classes.ConfirmPasswordContainer}>
            ...
            <div className={classes.ConfirmUserPasswordContainer}>
              ...
              {errors?.ConfirmPassword && (
                <small className={classes.UserConfirmPasswordMSG}>
                  {" "}
